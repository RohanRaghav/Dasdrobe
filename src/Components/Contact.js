        ...
        <div>
          ...
          <div className="contacting">
            ...
            <div>
              ...
              Sherpur Bypass, Grand Truck Rd
            </div>
            <div>Ludhiana, Punjab 141010</div>
          </div>
        </div>
        <div>
          <form className="ing">
            ...
            <div className="division" style={{ gap: "40px" }}>
              <div className="def">
                <label>Email</label>
                <input
                  type="text"
            ...
            <div className="def">
              <label>Message</label>
              <textarea className="contactformlabel" placeholder="......" />
            </div>
            <div className="submitcontact">Submit</div>
          </form>
        </div>
      </div>
    </div>
